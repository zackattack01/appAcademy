...
describe "#translate" do
  ...
  it "leaves word capitalization intact" do
    s = translate("The quick Brown fox")
    s.should == "Ethay ickquay Ownbray oxfay"
  end
  ...
  it "retains the punctuation from the original phrase" do
    s = translate("The fox is indeed brown, but is it quick?")
    s.should == "Ethay oxfay isay indeeday ownbray, utbay isay itay ickquay?"
  end
